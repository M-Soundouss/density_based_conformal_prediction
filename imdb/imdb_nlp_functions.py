...
from keras.layers import Activation, Dense, Dropout, Input, Embedding, Bidirectional, GRU, GlobalMaxPool1D
...
def get_model(n_classes=1, lr=0.00001, max_len=200, max_words=10000):
    input_layer = Input(name="inputs", shape=[max_len])
    x = Embedding(max_words, 50, input_length=max_len, name="embedding_1")(input_layer)
